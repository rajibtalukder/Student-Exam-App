...
import 'package:lexam/controllers/exam_screen_controller.dart';
import 'package:lexam/controllers/get_controllers.dart';
import 'package:get/get.dart';
import 'package:lexam/models/question_model.dart';
import 'package:lexam/views/dialogs/alert_dialog_loader.dart';
import 'package:lexam/views/dialogs/confirmation_dialog.dart';
                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: Container(
                              ...
                              color: AppColors.black,
                              child: Text(
                                '${controller.questions[i].ques?.data}',
      ...
      children: [
        Container(
            ...
            decoration: BoxDecoration(
                ...
                color: selectedOption == j ? AppColors.blue : AppColors.white,
                border: Border.all(
        ...
        Expanded(
          child: Text(
            text,
            style: selectedOption == j
                ? AppTextStyles.number
                : AppTextStyles.widgetTitle,
          ),
        ),
      ],
    );
