  ...
  Widget titleBarWidget() {
    return Row(
      children: [
        ...
        Text(
          'Check Result',
          style: AppTextStyles.examOption.copyWith(color: AppColors.black),
        ),
      ],
    );
  }
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(checkResultController.checkResultList[index].name, style: AppTextStyles.number),
              ],
            ),
            Row(
              children: [
                const Text('Total Mark : '),
                Text(checkResultController.checkResultList[index].examTotalMark
                    .toString(), style: AppTextStyles.number),
              ],
            ),
            Row(
              children: [
                const Text('Mark : '),
                Text(checkResultController.checkResultList[index].userMark
                    .toString(), style: AppTextStyles.number),
              ],
            ),
          ],
