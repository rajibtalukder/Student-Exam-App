...
import 'package:lexam/controllers/buy_course_screen_controller.dart';
import 'package:lexam/controllers/get_controllers.dart';
import 'package:get/get.dart';
import 'package:lexam/models/package_model.dart';
import 'package:lexam/models/payment_method_model.dart';
...
class BuyPackageScreen extends StatelessWidget {
                ...
                itemBuilder: (context, index) {
                  return InkWell(
                      onTap: (){
                        ...
                        controller.packageAmount.value = controller.package[controller.packageMethodIndex.value].amount!;
                        print(controller.packageMethodIndex);
                        print(controller.packageAmount.value);
                      },
                      child: packageItemWidget(controller.package[index],index));
                });
          }),
        ],
      ),
  ...
  Widget packageItemWidget(Package data, int index) {
    return Obx(()=>Container(
        ...
        padding: EdgeInsets.symmetric(vertical: 8.h, horizontal: 16.w),
        decoration: BoxDecoration(
            color: controller.packageMethodIndex.value==index ? AppColors.blueAccent: AppColors.lightBlueAccent,
