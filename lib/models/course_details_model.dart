...
class CourseDetailsModel {
  ...
  factory CourseDetailsModel.fromJson(String str) =>
      CourseDetailsModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory CourseDetailsModel.fromMap(Map<String, dynamic> json) =>
      CourseDetailsModel(
        userPayment: json["user_payment"],
        courseId: json["course_id"],
        course: json["course"] == null
            ? []
            : List<Course>.from(json["course"]!.map((x) => Course.fromMap(x))),
        courseTeacher: json["course_teacher"] == null
            ? []
            : List<CourseTeacher>.from(
                json["course_teacher"]!.map((x) => CourseTeacher.fromMap(x))),
        section: json["section"] == null
            ? []
            : List<Section>.from(
                json["section"]!.map((x) => Section.fromMap(x))),
        videoLecture: json["video_lecture"] == null
            ? []
            : List<VideoLecture>.from(
                json["video_lecture"]!.map((x) => VideoLecture.fromMap(x))),
        fileLecture: json["file_lecture"] == null
            ? []
            : List<FileLecture>.from(
                json["file_lecture"]!.map((x) => FileLecture.fromMap(x))),
        courseBanner: json["course_banner"] == null
            ? []
            : List<CourseBanner>.from(
                json["course_banner"]!.map((x) => CourseBanner.fromMap(x))),
        courseVideo: json["course_video"] == null
            ? []
            : List<CourseVideo>.from(
                json["course_video"]!.map((x) => CourseVideo.fromMap(x))),
      );
  ...
  Map<String, dynamic> toMap() => {
        ...
        "course": course == null
            ? []
            : List<dynamic>.from(course!.map((x) => x.toMap())),
        "course_teacher": courseTeacher == null
            ? []
            : List<dynamic>.from(courseTeacher!.map((x) => x.toMap())),
        "section": section == null
            ? []
            : List<dynamic>.from(section!.map((x) => x.toMap())),
        "video_lecture": videoLecture == null
            ? []
            : List<dynamic>.from(videoLecture!.map((x) => x.toMap())),
        "file_lecture": fileLecture == null
            ? []
            : List<dynamic>.from(fileLecture!.map((x) => x.toMap())),
        "course_banner": courseBanner == null
            ? []
            : List<dynamic>.from(courseBanner!.map((x) => x.toMap())),
        "course_video": courseVideo == null
            ? []
            : List<dynamic>.from(courseVideo!.map((x) => x.toMap())),
      };
}
...
class CourseBanner {
  ...
  factory CourseBanner.fromJson(String str) =>
      CourseBanner.fromMap(json.decode(str));
...
class CourseTeacher {
  ...
  factory CourseTeacher.fromJson(String str) =>
      CourseTeacher.fromMap(json.decode(str));
...
class CourseVideo {
  ...
  factory CourseVideo.fromJson(String str) =>
      CourseVideo.fromMap(json.decode(str));
...
class FileLecture {
  ...
  factory FileLecture.fromJson(String str) =>
      FileLecture.fromMap(json.decode(str));
...
class VideoLecture {
  ...
  factory VideoLecture.fromJson(String str) =>
      VideoLecture.fromMap(json.decode(str));
